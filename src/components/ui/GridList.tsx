...
const itemStyles = tv({
	extend: focusRing,
	base: "-mb-px -outline-offset-2 relative flex cursor-default select-none gap-3 border-transparent border-y px-3 py-2 text-gray-900 text-sm first:rounded-t-md first:border-t-0 last:mb-0 last:rounded-b-md last:border-b-0 dark:border-y-zinc-700 dark:text-zinc-200",
	variants: {
		isSelected: {
