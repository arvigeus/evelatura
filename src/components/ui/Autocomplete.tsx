...
export function AutocompleteSection<T extends object>(
	...
	return (
		<AriaMenuSection className="first:-mt-[5px] after:block after:h-[5px] after:content-['']">
			<Header className="-top-[5px] -mt-px -mx-1 sticky z-10 truncate rounded border border-gray-200 bg-gray-100/60 px-4 py-1 font-semibold text-gray-500 text-sm backdrop-blur-md supports-[-moz-appearance:none]:bg-gray-100 [&+*]:mt-1">
				{props.title}
			</Header>
